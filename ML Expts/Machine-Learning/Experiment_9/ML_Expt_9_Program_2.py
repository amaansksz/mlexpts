...
plt.title('2D PCA of Iris Dataset Amaan Shaikh 211P052')

# Modified legend creation: manually create legend handles for each target class
handles = []
...
ax.set_title('3D PCA of Iris Dataset Amaan Shaikh 211P052/41')

# Modified legend creation (for 3D plot): manually create legend handles
handles_3d = []
for i in range(len(iris_target_names)):
